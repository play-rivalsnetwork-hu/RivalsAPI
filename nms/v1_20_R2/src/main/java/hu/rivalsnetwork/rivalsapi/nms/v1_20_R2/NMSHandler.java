...
public class NMSHandler implements hu.rivalsnetwork.rivalsapi.nms.NMSHandler {
    ...
    public PacketEntity createPacketEntity(String name, Location location, String texture, String signature) {
        return new hu.rivalsnetwork.rivalsapi.nms.v1_20_R2.PacketEntity(name, location, texture, signature);
    }

    @Override
    public ItemStack wrapItemStack(org.bukkit.inventory.ItemStack itemStack) {
        return new hu.rivalsnetwork.rivalsapi.nms.v1_20_R2.ItemStack(itemStack);
    }

    @Override
    public ItemStack createItemStack(Material material) {
        return new hu.rivalsnetwork.rivalsapi.nms.v1_20_R2.ItemStack(new org.bukkit.inventory.ItemStack(material));
    }
    ...
    public Schematic getSchematic(@NotNull File file) {
        return new hu.rivalsnetwork.rivalsapi.nms.v1_20_R2.Schematic(file);
    }

    @Override
    public Hologram createHologram(Location location, String id, double lineHeight) {
        return new hu.rivalsnetwork.rivalsapi.nms.v1_20_R2.Hologram(location, id, lineHeight);
    }
}
