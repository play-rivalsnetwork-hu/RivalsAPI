...
public class PacketEntity implements hu.rivalsnetwork.rivalsapi.nms.PacketEntity {
    ...
    public PacketEntity(String name, Location location, String texture, String signature) {
        ...
        this.player = new ServerPlayer(MinecraftServer.getServer(), ((CraftWorld) location.getWorld()).getHandle().getLevel(), gameProfile);
        ...
        spawnPacket = new ClientboundAddPlayerPacket(this.player);
